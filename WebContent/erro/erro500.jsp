...
<body>
	<div class="container">
		<div class="row" id="pwd-container" style="background-color: #FFFFFF; padding: 20px;">
			<div class="col-md-4">
				<h1>Erro 500</h1>
				<b><center>Não foi possível resolver o problema, caso o
						erro persista, favor entre em contato com o administrador do
						sistema.</center></b>
				<center>
					<h4>Você terá que realizar o login novamente por motivos de
						segurança.</h4>
					<a href="http://www.topwinner.com.br/"><b>CLIQUE AQUÍ PARA
							REALIZAR O LOGIN</b></a>
				</center>
			</div>
		</div>
